...
#   File                :   main.py
#
#   Description         :   For app4b we're going to add the code to enable us to output to MongoDB time series collection.
#                       :   app4b collapsed the insertOne and insertMany into one function inserMongo and specifies via mode 
#                       :   if it is a single document => mode=1 => insertOne or an array of documents => mode=2 => insertMany
#                       :   with respective alignment in simulate in run_simulation function.
#
