...
#   File                :   main.py
#
#   Description         :   For app4a we're going to add the code to enable us to output to MongoDB time series collection.
#                       :   app4a uses 2 seperate functions for insertOne and insertMany, as per connections.py and the then
#                       :   usage in simulate.py in run_simulation function.
#
#
