...
def insertOne(mongodb_collection, siteId, payload, logger):
    ...
    try:
        ...
        logger.error('connection.insertOne - Site ID {siteId}, insertOne - FAILED, Err: {err}'.format(
            siteId=siteId,
            err=e
        ))
...
def insertMany(mongodb_collection, siteId, payload, logger):
    ...
    try:
        ...
        logger.error('connection.insertMany - Site ID {siteId}, insertMany - FAILED, Err: {err}'.format(
            siteId=siteId,
            err=e
        ))
