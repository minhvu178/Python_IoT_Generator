...
#                   :   In app4c we're making the calles to connection.py more generic, so that we have 1 create connection and 1 save payload call
#                   :   We will decide in connection.py which connection object to use and how to write the payload.
#
